...
if(args.Length < 1 || args.Length > 2) {
    ...
    Print($"usage: {startCommand} [-r] <path/file>",
        "",
...
// Handle the recursion parameter as lazily as possible.
var basePathIndex = 0;
var recurse = false;
if(args.Length > 1) {
    if(args[0].ToLower() == "-r") {
...
if(compLevel < CompLevel.Boom && !hasDoom2Maps) {
    ...
    if(mapList.Any(map => ultimateDoomMapRegEx.IsMatch(map.Name))) {
        ...
        goto endCompLevelAdjustment;  // You saw nothing.
    }
